...
INSERT INTO Employee (employee_id, name, position)
...
INSERT INTO Customer (customer_id, name, type, company, business_id)
SELECT customer_id, name, type, company, business_id
FROM stg_Customer;
...
INSERT INTO Equipment (equipment_id, category, subcategory, model, price_per_min)
SELECT equipment_id, category, subcategory, model, price_per_minute
FROM stg_Equipment;
...
INSERT INTO RentalPlace (place_id, type, name, address, city, country, employee_id)
SELECT place_id, type, name, address, city, country, employee_id
...
INSERT INTO EquipmentUnit (equipment_unit_id, equipment_id, serial_number, purchase_date, last_maintenance, condition)
SELECT equipment_unit_id, equipment_id, serial_number, purchase_date, last_maintenance, condition
...
INSERT INTO RentalTransaction (transaction_id, equipment_unit_id, customer_id, pickup_location_id, return_location_id, start_time, end_time, amount, km)
SELECT transaction_id, equipment_unit_id, customer_id, pickup_location_id, return_location_id, start_time, end_time, amount, km
